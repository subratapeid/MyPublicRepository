...
<div class="container mt-2 mb-3">
  <div class="card">
    <div class="card-header py-0 px-2">
      <h2 class="text-center">Change Default Password</h2>
    </div>

    <div class="card-body pb-5">

    <form class="row g-3 needs-validation" id="changePassword" action="" method="post" enctype="multipart/form-data" novalidate>
...
$(document).ready(function() {
    ...
    $('form').submit(function (e) {
       ...
       // Serialize form data
        ...
        $.ajax({
            url: 'codes/change_old_password.php',
            type: 'POST',
            data: formData,
