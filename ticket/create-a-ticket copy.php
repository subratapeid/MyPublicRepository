...
<div class="col-xl-4 col-md-6">
    ...
    <div class="input-group has-validation">
              <span class="input-group-text mdi mdi-account" id="inputGroupPrepend"></span>
    <input type="text" class="form-control" name="mobileNo" id="mobileNo" placeholder="Enter 10 Digit Mobile No" required>
  </div>
</div>
...
<div class="col-xl-4 col-md-6" hidden>
    ...
    <div class="input-group has-validation">
              <span class="input-group-text mdi mdi-account" id="inputGroupPrepend"></span>
    <input type="text" class="form-control" name="poPin" id="poPin" placeholder="Enter 6 Digit PIN" required>
  </div>
</div>
...
<!-- <div class="col-xl-4 col-md-6">
    ...
    <div class="input-group has-validation">
              <span class="input-group-text mdi mdi-account" id="inputGroupPrepend"></span>
    <input type="text" class="form-control" name="poName" id="poName" placeholder="Project Office Name" readonly >
  </div>
</div> -->
...
$(document).ready(function () {
    ...
    $('form').submit(function (e) {
        ...
        $.ajax({
            url: 'codes/create_a_ticket.php', // Replace with the actual backend script URL
            type: 'POST',
