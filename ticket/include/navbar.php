...
include 'codes/user_data_globaly.php';
?>
    ...
    <?php if (hasPermission('Add BC Details')): ?>
        ...
        <i class="fas fa-user-friends nav-icon"></i> BC Management</a>
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="all-bc-list.php"><span class="nav-icon"></span> All Existing BC</a></li>
            <li class="nav-item"><a class="nav-link" href="create-bc.php"><span class="nav-icon"></span> Create New BC</a></li>
            <li class="nav-item"><a class="nav-link" href="bc-bulk-upload.php"><span class="nav-icon"></span> Bulk Upload</a></li>
          </ul>
        </li>
   <?php endif; ?>
  <?php if (hasPermission('Create User')): ?>
        ...
        <i class="fas fa-users nav-icon"></i> User Management</a>
          ...
          <li class="nav-item"><a class="nav-link" href="create-user.php"><span class="nav-icon"></span> Create User</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="approve-user.php"><span class="nav-icon"></span> Approve Account</a></li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#"> 
        <i class="fas fa-building nav-icon"></i> Office Management</a>
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="all-offices-list.php"><span class="nav-icon"></span> Office List</a></li>
            <li class="nav-item"><a class="nav-link" href="add-offices.php"><span class="nav-icon"></span> Add Offices</a></li>
            <li class="nav-item"><a class="nav-link" href="office-bulk-upload.php"><span class="nav-icon"></span> Bulk Upload</a></li>
          </ul>
        </li>
        <?php endif; ?>
          <!-- Settngs Option -->
  ...
  <header class="header header-sticky">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="d-md-flex align-items-center mx-auto">
        <span id="time" class="m-0 text-center d-md-block d-none"></span>
      </div>
          ...
          <ul class="header-nav ms-3">
            ...
            <?php if (!isLoggedIn()): ?>
              <a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-md"><i class="fas fa-user avatar-icon"></i></div>
              </a>
              <?php endif; ?>
              <?php if (isLoggedIn()): ?> 
                <style>
...
.avatar img {
    width: 100%;
    height: 100%;
    object-fit: cover; /* Ensures the image covers the entire avatar area */
}
    ...
    display: block;
              ...
              <a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-md">
                  <img src="<?php echo $userAvatar; ?>" class="avatar-icon2">
                </div>
            </a>
            <?php endif; ?>
              ...
              <?php if (!isLoggedIn()): ?>
                ...
                <?php endif; ?>
                  ...
                  <?php if (isLoggedIn()): ?> 
                    <div class="dropdown-header bg-light py-2">
                    <div class="fw-semibold">Hello, <?php echo($usersFirstName);?></div>
                    </div>
                <?php endif; ?>
